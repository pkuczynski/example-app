...
export const outputBaseDirectory = `../build/${packageJson.name.split('/')[1]}/test`
...
const config: Config.InitialOptions = {
    ...
    // cacheDirectory: "/private/var/folders/l9/0l684lz55hzgybc8m8xj_my80000gn/T/jest_dx",
    ...
    coverageDirectory: `${outputBaseDirectory}/test`,
